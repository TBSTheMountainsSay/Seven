  ...
  return (
    <div className={styles.main}>
      ...
      <Description
        title={'Карта 9'}
        text={
          'Придумай ритуал, который все игроки должны будут выполнить каждый раз перед тем, как в следующий раз выпить. Ритуалы сохраняются до конца игры. Если ритуалов несколько, то игрок должен выполнить все друг за другом.'
        }
      />
      <Description
        title={'Карта 10'}
        text={
          'Никому нельзя отчечать на вопросы того, кто вытянул данную карту. Одновременно в игре данная карта действует только на 1 человека.'
        }
      />
      <Description
        title={'Карта J'}
